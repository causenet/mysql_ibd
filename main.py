...
if __name__ == '__main__':
    import yaml
    import argparse
    parser = argparse.ArgumentParser(description='generate sql from ibd for mysql innodb engine, and import data from ibd automaticlly')
    ...
    load_parser = subparsers.add_parser('load_data', help='load data from ibd for tables')
